...
export const ConstellationGrid: React.FC<ConstellationGridProps> = ({
    ...
    useEffect(() => {
        ...
        setIsDarkMode(true); // Default to dark for cinematic portfolio aesthetic
    ...
    useEffect(() => {
        ...
        const render = (now: number) => {
            ...
            // Color paletting for dark cinematic aesthetic
            ...
            for (let i = 0; i < nodes.length; i++) {
                ...
                for (let j = i + 1; j < nodes.length; j++) {
                    ...
                    if (distSq < MAX_CONN_DIST_SQ) {
                        ...
                        const alpha = (1 - nDist / MAX_CONN_DIST) * (isDarkMode ? 0.22 : 0.08);
            ...
            for (let i = 0; i < nodes.length; i++) {
                ...
                const baseAlpha = isNear ? 0.95 : 0.28 + Math.sin(n.pulse) * 0.12;
    ...
    return (
        <div className={`fixed inset-0 pointer-events-none z-[2] overflow-hidden select-none ${className}`}>
